  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl">
        ...
        <div
          className="h-1 w-20 bg-primary-600 dark:bg-primary-400 mx-auto mb-12"
          role="presentation"
        />
        ...
        <div>
          ...
          <ul
            className="flex flex-wrap justify-center gap-x-3 gap-y-6 list-none p-0 m-0"
            role="list"
          >
            {skills.map(skill => (
              <li key={skill}>
                <span className="px-6 py-2 bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 rounded-full font-medium hover:bg-primary-200 dark:hover:bg-primary-800 transition-colors">
                  {skill}
                </span>
              </li>
            ))}
